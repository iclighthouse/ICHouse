export default ({ IDL }) => {
  ...
  const TradingStatus__1 = IDL.Variant({
    Todo: IDL.Null,
    Closed: IDL.Null,
    Cancelled: IDL.Null,
    Pending: IDL.Null
  ...
  const TradingOrder__1 = IDL.Record({
    fee: IDL.Record({ fee0: IDL.Nat, fee1: IDL.Nat }),
  ...
  return IDL.Service({
    cancel: IDL.Func([IDL.Nat, IDL.Opt(Sa)], [], []),
    cancelByTxid: IDL.Func([Txid__1, IDL.Opt(Sa)], [], []),
    changeOwner: IDL.Func([IDL.Principal], [IDL.Bool], []),
    comp_deposit: IDL.Func([Amount, Amount, IDL.Opt(Sa)], [], []),
    comp_dropout: IDL.Func([IDL.Opt(Sa)], [IDL.Bool], []),
    comp_fallback: IDL.Func([IDL.Opt(Sa)], [Amount, Amount], []),
    ...
    comp_withdraw: IDL.Func([IDL.Opt(Sa)], [Amount, Amount], []),
    config: IDL.Func([DexConfig], [IDL.Bool], []),
    count: IDL.Func([IDL.Opt(Address)], [IDL.Nat], ['query']),
    debug_pendingTxids: IDL.Func([], [IDL.Nat, IDL.Text], ['query']),
    ...
    fallback: IDL.Func([IDL.Nat, IDL.Opt(Sa)], [IDL.Bool], []),
    fallbackByTxid: IDL.Func([Txid__1, IDL.Opt(Sa)], [IDL.Bool], []),
    feeStatus: IDL.Func([], [FeeStatus], ['query']),
    getConfig: IDL.Func([], [DexSetting], ['query']),
    getDip20Balance: IDL.Func([Address], [IDL.Nat, IDL.Principal], ['query']),
    getOwner: IDL.Func([], [IDL.Principal], ['query']),
    getQuotes: IDL.Func([KInterval], [IDL.Vec(KBar)], ['query']),
    getTxAccount: IDL.Func(
      [Address],
      [Account__1, TxAccount, Nonce__1, Txid__1],
      ['query']
    ),
    getTxDip20Balance: IDL.Func(
      [IDL.Text],
      [IDL.Opt(IDL.Tuple(IDL.Nat, IDL.Principal))],
      ['query']
    ),
    ...
    ictc_manageOrder1: IDL.Func(
      [Txid__1, TradingStatus__1, Amount, Amount, Amount, Amount],
      [IDL.Bool],
      []
    ),
    ...
    prepare: IDL.Func([Address], [TxAccount, Nonce__1], ['query']),
    ...
    tradeMKT: IDL.Func(
      [IDL.Principal, Amount, IDL.Opt(IDL.Nat), IDL.Opt(Sa), IDL.Opt(Data)],
      [TradingResult],
      []
    ),
